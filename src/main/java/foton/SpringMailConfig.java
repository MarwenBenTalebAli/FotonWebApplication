 ...
 */
@Configuration
@PropertySource("classpath:mailConfig/emailServerConfig.properties")
public class SpringMailConfig implements ApplicationContextAware, EnvironmentAware {

	public static final String EMAIL_TEMPLATE_ENCODING = "UTF-8";

	private static final String JAVA_MAIL_FILE = "classpath:mailConfig/javamail.properties";
	...
	@Bean(name = "emailMessageSourceBean")
	...
	@Bean(name = "emailTemplateEngineBean")
